...
export function BottomNav() {
  ...
  return (
    <div className="md:hidden fixed bottom-4 left-1/2 -translate-x-1/2 flex items-center gap-4 z-50">
          ...
          {NAVIGATION_ITEMS.map((item) => {
            ...
            return (
              <Link
                ...
                className={cn(
                  'flex flex-row items-center px-4 py-3 rounded-full text-xs font-medium transition-[width,opacity] duration-300 relative overflow-hidden hover:bg-white/10 active:scale-90 transition-transform duration-75',
